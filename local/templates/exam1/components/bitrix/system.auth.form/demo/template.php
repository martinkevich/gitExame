...
if ($arResult["FORM_TYPE"] == "login") {
        ...
        <ul>
            <li class="att popup-wrap"><a id="hd_singin_but_open" href=""
                ...
                <form class="frm-login popup-block" name="system_auth_form<?= $arResult["RND"] ?>" method="post"
                    ...
                    <div class="frm-row">
                        <a href="user/<?=$arParams['FORGOT_PASSWORD_URL']?>" class="btn-forgot"><?= GetMessage("AUTH_FORGOT_PASSWORD_2") ?></a>
                    </div>
                    <div class="frm-row">
                        <div class="frm-chk">
            ...
            <li><a href="user<?=$arParams['REGISTER_URL']?>"><?= GetMessage("AUTH_REGISTER") ?></a></li>
        </ul>
    </nav>
    <?
    ...
    <nav class="menu-block">
        <ul>
            <li>
                <a href=""><?= $arResult['USER_NAME'] ?> [<?= $arResult['USER_LOGIN'] ?>]</a>
            </li>
